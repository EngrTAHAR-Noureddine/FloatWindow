...
class AccessibilityService : AccessibilityService() {
    ...
    private fun createWindow(){
       ...
       // mLayout?.background = ContextCompat.getDrawable(this, R.drawable.notif)
        ...
        val windowParent = mLayout?.findViewById(R.id.action_bar) as ConstraintLayout
       ...
       screenOnOffReceiver = object : BroadcastReceiver() {
            ...
            override fun onReceive(context: Context, intent: Intent) {
                ...
                if(strAction == Intent.ACTION_SCREEN_OFF){
                    ...
                    println("is enabled accessebility service : ${this@AccessibilityService.accessibilityButtonController.isAccessibilityButtonAvailable}")
                    if(mLayout == null) {
                        createWindow()
                    }
                } else {
